...
HD_PWD='C:/Users/marco/Documents/GitHub/VGA-Controller/impl/VGA-Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_top.tcl
