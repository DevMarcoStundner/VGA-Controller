...
HD_PWD='C:/Users/marco/Documents/GitHub/VGA-Controller/impl/VGA-Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_top.tcl -notrace
