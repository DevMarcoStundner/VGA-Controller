...
HD_PWD='C:/Users/marco/Desktop/FH/CHIP2/VGA_Controller/generate/managed_ip_project/managed_ip_project.runs/memory_obj_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_obj.vds -m64 -mode batch -messageDb vivado.pb -notrace -source memory_obj.tcl
